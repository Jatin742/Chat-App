...
import { animationDefaultOptions, getColor } from "@/app/lib/utils/colors";
                ...
                >
                    ...
                    {searchedContacts.length == 0 &&
                        <div className='flex-1 md:bg-[#1c1d25] md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all'>
                            ...
                            />
                            <div className="opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center">
